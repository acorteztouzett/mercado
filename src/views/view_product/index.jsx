...
const ViewProduct = () => {
  ...
  useScrollTop();
  useDocumentTitle(`Ver ${product?.name || 'Producto'}`);
        ...
        <div className="product-view">
          ...
          <div className="product-modal">
            ...
            <div className="product-modal-details">
              ...
              <br />
              <div>
                <span className="text-subtle">Seleccione medida</span>
                <br />
                <br />
                <Select
              ...
              <div className="product-modal-action">
                <button
                  ...
                  type="button"
                >
                  {isItemOnBasket(product.id) ? 'Quitar del carrito' : 'Agregar al carrito'}
                </button>
              </div>
            </div>
          </div>
