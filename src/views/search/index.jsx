    ...
    return (
      <main className="content">
        <MessageDisplay
          ...
          desc="Intenta de nuevo con otra palabra."
        />
      </main>
    );
  }
            ...
            {!store.requestStatus && (
              <div className="product-list-header">
                <div className="product-list-header-title">
                  <h5>
                    {`Se encontró ${store.products.length} ${store.products.length > 1||store.products.length ==0  ? 'productos' : 'producto'} con la palabra ${searchKey}`}
                  </h5>
                </div>
              </div>
            )}
