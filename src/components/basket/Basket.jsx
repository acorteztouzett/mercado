...
const Basket = () => {
  ...
  return user && user.role === 'ADMIN' ? null : (
    <Boundary>
      ...
      >
        <p className="text-center">Debes ingresar para continuar con la compra</p>
        <br />
      ...
      <div className="basket">
        <div className="basket-list">
          <div className="basket-header">
            <h3 className="basket-header-title">
              ...
              <span>
                (
                {` ${basket.length} ${basket.length > 1 || basket.length==0 ? 'productos' : 'producto'}`}
                )
              </span>
            </h3>
            <BasketToggle>
        ...
        <div className="basket-checkout">
          <div className="basket-total">
            <p className="basket-total-title">Precio S/.</p>
